//Alex Schwiegeraht
//Description: AVL Tree class with find method added
...
//Finds the kth smallest element
  ...
  //Gives all the nodes their height
  public void getNodeSizes() {
	  getNodeSizes((AVLTreeNode<E>) root);
  }

  //Helper method for getNodeSizes()
  private int getNodeSizes(AVLTreeNode<E> node) {
	  if (node == null)
		  return 0;
	  else {
		  node.size = 1 + getNodeSizes((AVLTreeNode<E>)(node.left)) + getNodeSizes((AVLTreeNode<E>)(node.right));
		  return node.size;
	  }
  }
