//Alex Schwiegeraht
//Description: Creates a binary search tree to display
...
public class BTView<E> extends Pane {
	...
	private ArrayList<BST.TreeNode<E>> shadedNodes = new ArrayList<>();
	...
	public void setShadedNodes(ArrayList<BST.TreeNode<E>> shadedNodes){
		this.shadedNodes = shadedNodes;
	}

	public ArrayList<BST.TreeNode<E>> getShadedNodes(){
		return shadedNodes;
	}
