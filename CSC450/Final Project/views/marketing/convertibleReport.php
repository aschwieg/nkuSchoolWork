<div class="container">
    ...
    <div class="text-center" style="padding:50px;">
        <h2 style="margin-bottom:15px;">Convertible Report</h2>
        <div class="row">     
            <div class="col">
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="marketing.php?action=convertible&item=report">Convertible Sales Report</a>
