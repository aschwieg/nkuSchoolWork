<div class="container">
    ...
    <div class="text-center" style="padding:50px;">
        <h2 style="margin-bottom:15px;">Inventory Report</h2>
        <div class="row">     
            <div class="col">
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="marketing.php?action=inventory&item=report">Inventory Report</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php foreach($rows as $row) : ?>
                            <tr>
                                ...
                                <td><?php echo $row['AVERAGE_LOT_TIME']; ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
