<div class="container">
    ...
    <div class="text-center" style="padding:50px;">
        <h2 style="margin-bottom:15px;">Top Brand (Unit) Report</h2>
        <div class="row">     
            <div class="col">
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="marketing.php?action=brandUnit&item=report">Top Brand Unit Sales Report</a>
